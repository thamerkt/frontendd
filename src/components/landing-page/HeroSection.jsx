...
export default function PartnerHeroSection() {
  ...
  return (
    <div className="relative w-full h-[100vh] min-h-[800px] max-h-[1000px] overflow-hidden group">
      ...
      <AnimatePresence custom={direction} initial={false}>
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/40 to-black/20 flex flex-col items-center justify-center text-white">
            <div className="text-center px-4 w-full max-w-5xl mt-[-200px]">
              {/* Badge */}
              ...
              <motion.h1
                className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 leading-tight text-white drop-shadow-lg"
              ...
              <motion.p
                className="text-lg md:text-xl mb-6 max-w-2xl mx-auto text-white/90 drop-shadow-md"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ 
                  delay: 0.4,
              ...
              {slides[currentIndex].price && (
                <motion.div
                  className="text-xl font-semibold mb-8 text-teal-300 drop-shadow-md"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
      ...
      <div className="absolute bottom-72 left-1/2 transform -translate-x-1/2 z-10 w-full max-w-md px-4">
  <motion.div
  ...
  >
    <a 
      ...
      className="flex items-center justify-center gap-2 bg-teal-600 hover:bg-teal-700 w-full sm:w-[260px] px-6 py-2.5 text-white font-semibold text-lg rounded-lg transition-all duration-300 transform hover:scale-[1.02] shadow-lg hover:shadow-teal-500/20"
    >
    ...
    <a 
      ...
      className="flex items-center justify-center gap-2 bg-white/10 backdrop-blur-md hover:bg-white/20 w-full sm:w-[260px] px-6 py-2.5 text-white font-semibold text-lg rounded-lg transition-all duration-300 transform hover:scale-[1.02] shadow-lg border border-white/20"
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 z-10 py-6 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-xl font-bold text-white mb-4 text-center drop-shadow-md">Your Complete Partner Solution</h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              >
                ...
                <h3 className="font-semibold text-white text-sm md:text-base mb-1 drop-shadow-sm">{benefit.title}</h3>
                <p className="text-xs md:text-sm text-white/80 drop-shadow-sm">{benefit.description}</p>
              </motion.div>
            ))}
          </div>
          
          {/* Navigation circles moved here under the cards */}
