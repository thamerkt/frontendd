...
// API Configuration
const API_BASE_URL = "https://kong-7e283b39dauspilq0.kongcloud.dev/api";
const PROFILE_API_URL = "https://kong-7e283b39dauspilq0.kongcloud.dev/profile/profil/";
...
const apiService = {
  ...
  reports: {
    getByUser: async (username) => {
      const response = await axios.get(`https://kong-7e283b39dauspilq0.kongcloud.dev/reports/rapports/?user=${username}`);
      return response.data;
    },
  ...
  reportData: {
    getByReport: async (reportId) => {
      const response = await axios.get(`https://kong-7e283b39dauspilq0.kongcloud.dev/reports/rapport-data/?rapport=${reportId}`);
      return response.data;
    },
    create: async (metricData) => {
      const response = await axios.post('https://kong-7e283b39dauspilq0.kongcloud.dev/reports/rapport-data/', metricData);
      return response.data;
    }
  }
};
