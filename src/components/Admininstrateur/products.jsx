...
// API Configuration
const API_BASE_URL = "https://f7d3-197-27-48-225.ngrok-free.app/api";
const PROFILE_API_URL = "https://f7d3-197-27-48-225.ngrok-free.app/profile/profil/";
...
const apiService = {
  ...
  reports: {
    getByUser: async (username) => {
      const response = await axios.get(`https://f7d3-197-27-48-225.ngrok-free.app/reports/rapports/?user=${username}`);
      return response.data;
    },
  ...
  reportData: {
    getByReport: async (reportId) => {
      const response = await axios.get(`https://f7d3-197-27-48-225.ngrok-free.app/reports/rapport-data/?rapport=${reportId}`);
      return response.data;
    },
    create: async (metricData) => {
      const response = await axios.post('https://f7d3-197-27-48-225.ngrok-free.app/reports/rapport-data/', metricData);
      return response.data;
    }
  }
};
